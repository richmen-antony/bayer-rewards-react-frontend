...
class ChannelPartners extends Component<Props & RouteComponentProps, States> {
  ...
  generateHeader(allChannelPartners: any, isAsc: Boolean) {
    ...
    res.push(
      <th
        style={{ width: "150px" }}
        onClick={(e) =>
          this.handleSort(e, "accountname", allChannelPartners, isAsc)
        }
      >
        {"Account Name"}
    ...
    res.push(
      <th
        style={{ width: "140px" }}
        onClick={(e) =>
          this.handleSort(e, "ownername", allChannelPartners, isAsc)
        }
      >
        {"Owner Name"}
  ...
  getCurrentUserData = (data: any) => {
    ...
    let activeStatus =
      passData.status === "Inactive" || passData.status === "Declined"
        ? false
        : true;
    this.setState({
      userData: passData,
              ...
              <div className="popup-container">
                ...
                <div>
                  ...
                  <div className="col-sm-12" style={{ display: "flex" }}>
                    ...
                    <div
                      className="col-sm-6 editFilterText"
                  ...
                  <AUX key={i}>
                    ...
                    >
                      ...
                      <td style={{ width: "100px" }}>
                        {list.lastupdatedby}
                        <p>
                          {moment(list.lastupdateddate).format("DD-MM-YYYY")}{" "}
                        </p>
                      </td>
                      <td style={{ width: "100px" }}>
