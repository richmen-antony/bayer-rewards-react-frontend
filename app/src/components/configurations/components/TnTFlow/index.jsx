    ...
    <div className="col-md-10">
      <div className="container">
        ...
        <div className="col-sm-3">
            <div><label className="font-weight-bold pt-4">Code</label></div>
            <div>
                <Input style={dpstyle} type="text" className="form-control" name="code" />
            </div>
        </div>
          <div className="col-sm-3">
          ...
          <div className="col-sm-3">
            <div><label className="font-weight-bold pt-4">Level</label></div>
            <div>   <select style={dpstyle} id="dropdown">
              <option value="N/A">N/A</option>
              <option value="1">1</option>
              <option value="2">2</option>
