...
class Dashboard extends Component<Props, States> {
  ...
  componentDidMount() {
    ...
    if (userData?.role === ADMIN_ROLE) this.getAdminDashboardDetails();
    if (userData?.role === RSM_ROLE) this.getrsmDashboardDetails();
  }
            ...
            <div className="dashboard">
              ...
              <div style={{marginRight: "30px"}}>
                ...
                >
                  ...
                  <span className="title">
                    <FormattedMessage id="dashboard.scanLogs" />
                  </span>
                </CustomCard>
              </div>
              {/* ) : null} */}
              <div>
                <CustomCard icon={userlist} border="1px solid #206BDD" background="#DFE8FA">
                  ...
                  <br />
                  <span className="title">
                    <FormattedMessage id="dashboard.totalUsers" />
                  </span>
                </CustomCard>
              </div>
            </div>
            ...
            this.state.userRole === ADMIN_ROLE && (
              <div className="dashboard">
                <div className="card-list">
                  ...
                  >
                    <span className="title">
                      <FormattedMessage id="dashboard.createNewUser" />
                    </span>
                  </CustomCard>
                </div>
                <div className="card-list">
                ...
                <div className="card-list">
                  ...
                  >
                    ...
                    <br />
                    <span className="title">
                      <FormattedMessage id="dashboard.totalOrders" />
                    </span>
                  </CustomCard>
                </div>
                <div className="card-list">
          ...
          {this.state.userRole === "DEVADMIN" && (
            <div className="dashboard">
              <div style={{marginRight: "30px"}}>
                ...
                >
                  <span className="title">
                    <FormattedMessage id="dashboard.devAdmin" />
                  </span>
                </CustomCard>
              </div>
            </div>
