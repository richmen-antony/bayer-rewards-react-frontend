...
const Inventory = (Props: any) => {
  ...
  const [packageType, setPackageType] = useState({
    value: package_type[0],
    label: package_type[0],
  });
  ...
  const handleReactSelect = (
    ...
    if (e.name === "selectedYear") {
      ...
      let condOptionName = optionName?.includes("geolevel")
        ? "selected" + _.capitalize(optionName) + "Options"
        : optionName;
      setSelectedFilters({
        ...selectedFilters,
