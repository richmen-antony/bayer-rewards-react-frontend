...
class Distributor extends Component<Props, States> {
  ...
  handleScanDropdown = () => {};
  render() {
    const { retailerPopupData, isAsc, allDistributorData, isLoader, condFilterScan, activeSortKeyIcon, loggedUserInfo } =
      this.state;
    return (
      <AUX>
        {isLoader && <Loader />}
        <table className="table">
          <thead>
            <tr>
              ...
              >
                <FormattedMessage id="scanLog.labelBatchIdHeader" />
                {activeSortKeyIcon === "labelid" ? (
              ...
              <th style={{ width: "16%" }} onClick={(e) => this.handleSort(e, "soldtoname", allDistributorData, isAsc)}>
                <FormattedMessage id="scanLog.sg.cusNameIdHeader" />
              ...
              >
                <FormattedMessage id="scanLog.expDateHeader" />
