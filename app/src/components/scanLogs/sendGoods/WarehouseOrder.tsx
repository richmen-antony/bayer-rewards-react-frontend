            ...
            <ul className="progressBar">
              <li className="active">
                <div className="line-cnt">
                  <p>
                    <FormattedMessage id="scanLog.productPopup.dispatchDt" />
                  </p>
                ...
                <div className="content">
                  ...
                  <p>
                    <FormattedMessage id="scanLog.productPopup.warhouseNameId" />
                  </p>
                  <span>
              ...
              >
                <div className="line-cnt-expiry-date">
                  <p>
                    {" "}
                    <FormattedMessage id="scanLog.productPopup.receivedDt" />
                  </p>
                ...
                <div className="content">
                  ...
                  <p>
                    <FormattedMessage id="scanLog.productPopup.scanIdName" />
                  </p>
                  <span>
                ...
                <table className="table">
                  <thead>
                    <tr>
                      ...
                      <th>
                        <FormattedMessage id="scanLog.productPopup.dispatchedQty" />
                      </th>
                      <th></th>
                    </tr>
                  </thead>
                                ...
                                <div>
                                  <div className="inner-expand">
                                    <div className="title inner-row">
                                      ...
                                      <p className="sub-val">
                                        <FormattedMessage id="scanLog.productPopup.expDate" />
                                      </p>
                                    </div>
                                      ...
                                      value.qrCodes.map((list: any, qrIndex: number) => {
                                        return (
                                          <div className="inner-row font-13px" key={qrIndex}>
                                            ...
                                            <p className="sub-val">
                                              {(list.expirydate && moment(list.expirydate).format("DD/MM/YYYY")) || "-"}
                                            </p>
                                          </div>
                                        );
                                      })}
