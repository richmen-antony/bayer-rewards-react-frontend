          ...
          <thead>
            <tr>
              <th style={{ width: "10%" }} onClick={(e) => this.handleSort(e, "deliveryid", allWarehouseData, isAsc)}>
                <FormattedMessage id="scanLog.sg.deliveryHeader" /> #
                {activeSortKeyIcon === "deliveryid" ? (
              ...
              <th style={{ width: "16%" }} onClick={(e) => this.handleSort(e, "warehousename", allWarehouseData, isAsc)}>
                <FormattedMessage id="scanLog.sg.warehouseNameIdHeader" />
              ...
              <th style={{ width: "16%" }} onClick={(e) => this.handleSort(e, "tousername", allWarehouseData, isAsc)}>
                {this.props.selectedScanType === "SG - W2R" ? (
                  <FormattedMessage id="scanLog.retailerNameIdHeader" />
                ) : (
                  <FormattedMessage id="scanLog.distNameIdHeader" />
                )}
              ...
              {this.props.selectedScanType === "SG - W2R" && (
                <th style={{ width: "10%" }} onClick={(e) => this.handleSort(e, "touserstorename", allWarehouseData, isAsc)}>
                  <FormattedMessage id="scanLog.storeNameHeader" />
              ...
              <th style={{ width: "15%" }} onClick={(e) => this.handleSort(e, "scannedbyname", allWarehouseData, isAsc)}>
                <FormattedMessage id="scanLog.scanByHeader" />
              ...
              <th
                ...
                onClick={(e) => this.handleSort(e, "totalqty", allWarehouseData, isAsc)}
              >
                <FormattedMessage id="scanLog.sg.totalQtyHeader" />
                {activeSortKeyIcon === "totalqty" ? (
                  <i className={`fas ${isAsc ? "fa-sort-down" : "fa-sort-up"} ml-2`}></i>
                ) : null}
              </th>
              <th style={{ width: "12%" }} onClick={(e) => this.handleSort(e, "deliverystatus", allWarehouseData, isAsc)}>
                <FormattedMessage id="scanLog.sg.gdStatusHeader" />
                {activeSortKeyIcon === "deliverystatus" ? (
                  <i className={`fas ${isAsc ? "fa-sort-down" : "fa-sort-up"} ml-2`}></i>
                ) : null}
              </th>
              {loggedUserInfo?.role === ADMIN_ROLE && (
                <th style={{ width: "10%" }} onClick={(e) => this.handleSort(e, "scannedbygeo1", allWarehouseData, isAsc)}>
                  <FormattedMessage id="scanLog.regionHeader" />
                  {activeSortKeyIcon === "scannedbygeo1" ? (
                    <i className={`fas ${isAsc ? "fa-sort-down" : "fa-sort-up"} ml-2`}></i>
                  ) : null}
                </th>
              )}
              <th style={{ width: "10%" }} onClick={(e) => this.handleSort(e, "updateddate", allWarehouseData, isAsc)}>
                <FormattedMessage id="scanLog.updatedDtHeader" />
                  ...
                  >
                    ...
                    <td>
                      <div className="farmer-id">
                        ...
                        <label>{value.warehouseid === null ? "" : value.warehouseid}</label>
                      </div>
                    </td>
                    ...
                    <td>{value.updateddate && moment(value.updateddate).format("DD/MM/YYYY")}</td>
                    <td>
                ...
                <div className="popup-content">
                  ...
                  <div className="popup-content-row">
                    ...
                    <div className="content-list">
                      ...
                      <p>
                        {retailerPopupData[condFilterScan === "distAndRetailer" ? "touserstorename" : "soldbystore"] || "NA"}
                      </p>
                    </div>
                    <div className="content-list">
                      <label>
                    ...
                    <div className="content-list">
                      ...
                      <p>
                        {retailerPopupData[condFilterScan === "distAndRetailer" ? "touserzipcode" : "soldbyzipcode"] || "NA"}
                      </p>
                    </div>
                  </div>
                </div>
