...
import { invokeGetAuthService,invokeGetService } from '../../utility/base/service';
                    ...
                    <div className="table-responsive">
                        <table className="table" id="tableData">
                            ...
                            { allScanLogs.map((list,i) => 
                                <AUX key={i}>
                                    <tr class="accordion-toggle collapsed  class='expand-button'" id="accordion1" data-toggle="collapse" data-parent="#accordion1" href="#collapseOne" style={list.scanstatus === 'valid' ? {borderLeft: '5px solid #89D329'} : {borderLeft: '5px solid #FF4848' }}
