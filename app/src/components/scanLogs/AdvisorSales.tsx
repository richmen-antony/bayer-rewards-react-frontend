...
class AdvisorSales extends PureComponent<Props, States> {
  ...
  render() {
    const { retailerPopupData, showProductPopup, isAsc, allAdvisorSalesData, isLoader } = this.state;
    return (
      <AUX>
        {isLoader && <Loader />}
        <div>
          <table className="table">
            <thead>
              <tr>
                <th
                  style={{ width: "10%" }}
                  onClick={(e) => this.handleSort(e, "advisororderid", allAdvisorSalesData, isAsc)}
                >
                  <FormattedMessage id="scanLog.st.orderIdHeader" />
                ...
                <th style={{ width: "10%" }} onClick={(e) => this.handleSort(e, "storename", allAdvisorSalesData, isAsc)}>
                ...
                <th
                  style={{ width: "20%" }}
                  onClick={(e) => this.handleSort(e, "lastupdateddate", allAdvisorSalesData, isAsc)}
                >
