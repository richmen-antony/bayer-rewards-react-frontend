...
class WalkInSales extends PureComponent<Props, States> {
  ...
  render() {
    const { retailerPopupData, isAsc, allWalkInSalesData, isLoader, condFilterScan, activeSortKeyIcon } = this.state;
            ...
            <thead>
              <tr>
                ...
                <th style={{ width: "18%" }} onClick={(e) => this.handleSort(e, "soldtoname", allWalkInSalesData, isAsc)}>
                  <FormattedMessage id="scanLog.st.farmerNameIdHeader" />
