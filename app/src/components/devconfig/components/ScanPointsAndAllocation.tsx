...
export const ScanPointsAndAllocation = (props: IScanPointsAndAllocationProps) => {
    ...
    const handleAddClick = (index: any) => {
        setInputList([...inputList, { position: { id: 0, value: "NA" }, scannedby: { id: 0, value: "NA" }, scannedtype: { id: 0, value: "NA" }, packaginglevel: { id: 0, value: "NA" }, pointsallocated: { id: 0, value: "NA" } }]);
    };
                          ...
                          this.state.dpList.map(({ locationhierarchy }) => (
                            <option value={locationhierarchy} key={locationhierarchy}>
                              {locationhierarchy}
                                        ...
                                        <td className="tableHeaderStyle">
                                            <select className="dpstyle" id="dropdown" name="scannedby" value={item.scannedby.value} onChange={(event) => handleScannedbyChange(event, idx)}>
                                                <option value="Plant" key="Plant">Plant</option>
                                                <option value="Warehouse" key="Warehouse">Warehouse</option>
                                                {/* {idx > 0 && this.state.dpList.length > 0 && (
                          this.state.dpList.map(({ locationhierarchy }) => (
                            <option value={locationhierarchy} key={locationhierarchy}>
                              {locationhierarchy}
                                        ...
                                        <td className="tableHeaderStyle">
                                            <select className="dpstyle" id="dropdown" name="scannedtype" value={item.scannedtype.value} onChange={(event) => handleScannedtypeChange(event, idx)}>
                          ...
                          this.state.dpList.map(({ locationhierarchy }) => (
                            <option value={locationhierarchy} key={locationhierarchy}>
                              {locationhierarchy}
                                        ...
                                        <td className="tableHeaderStyle">
                                            <select className="dpstyle" id="dropdown" name="packaginglevel" value={item.packaginglevel.value} onChange={(event) => handlePackaginglevelChange(event, idx)}>
                          ...
                          this.state.dpList.map(({ locationhierarchy }) => (
                            <option value={locationhierarchy} key={locationhierarchy}>
                              {locationhierarchy}
                                        ...
                                        <td className="tableHeaderStyle">
                                            <select className="dpstyle" id="dropdown" name="pointsallocated" value={item.pointsallocated.value} onChange={(event) => handlePointsallocatedChange(event, idx)}>
