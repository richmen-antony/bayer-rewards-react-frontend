...
> {
  ...
  handleReset() {
    ...
    //   isActive: false,
    // });
    let defalutCountry: string =
      selectedCountryDetails?.length > 0 && selectedCountryDetails[0].name;
  ...
  componentDidUpdate(prevProps: any, prevState: any) {
    ...
    if (
      this.props.scanpointsandallocationinputList !==
      prevProps.scanpointsandallocationinputList
    ) {
      this.setState({
