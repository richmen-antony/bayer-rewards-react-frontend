...
class Devconfigurations extends React.Component<IDevConfigProps, MyComponentState> {
  ...
  handleClick(clickType?: any, e?: any) {
    ...
    if (clickType === undefined) {
      ...
      // handle the restricted  getTemplateData API
      if (currentStep === 1) {
        this.setState({ isRestrictAPI: true });
      }
    }
  ...
  handleReset() {
    ...
    switch (currentStep) {
      case 1:
        ...
        this.handleRestrictCountryAPI();
        break;
      case 2:
        this.props.addLocationInputList({});
        this.props.addLocationInputList([{ level: 0, name: "", parentlevel: -1 }]);
        newStep = 2;
        break;
      case 3:
  ...
  /**
   * This method handle the unrestricted the API (getTemplateData)
   */
  handleRestrictCountryAPI = () => {
    this.setState({ isRestrictAPI: false });
  };
      ...
      case 1:
        return (
          <CountrySetup
            ...
            restrictCountryAPI={isRestrictAPI}
            handleRestrictCountryAPI={this.handleRestrictCountryAPI}
          />
        );
      case 2:
        return (
    ...
    if (currentStep === stepsArray.length) {
      ...
      button = (
        <button className="btnNextSubmit cus-btn-dev" onClick={(e) => this.handleClick("next", e)}>
          <FormattedMessage id="button.next" /> <img src={right_arrow} alt="" />
        </button>
      );
    }
