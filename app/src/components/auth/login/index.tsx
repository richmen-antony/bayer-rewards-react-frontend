        ...
        <div className=" col-md-10 ~form">
          ...
          <form className="form-horizontal">
            <div className="form-group">
              ...
              <input
                type="text"
                className={!usernameError ? "form-control" : "form-control invalid loginStyle"}
                name="username"
            ...
            <div className="form-group">
              ...
              <div className="withIcon">
                <input
                  ...
                  className={!passwordError ? "form-control" : "form-control invalid"}
                  name="password"
            ...
            <div className="form-group row m-t-20">
              ...
              <div className="col-sm-12 text-center">{validErrorMsg && <span className="error">{validErrorMsg} </span>}</div>
            </div>
