...
export const getOverallScans = (data: {}) => {
  return async (dispatch: Dispatch<AnyAction>) => {
    ...
    function Success(scans: any) {
      return { type: GET_OVERALL_CONSOLIDATED_SCANS_SUCCESS, scans };
    }
    function Error(errorMsg: any) {
      return { type: GET_OVERALL_CONSOLIDATED_SCANS_ERROR, errorMsg };
    }
  };
};
...
export const getScannedBrands = (soldbyid: string, isfiltered: boolean, filteredDatas: {}) => {
  return async (dispatch: Dispatch<AnyAction>) => {
    ...
    function Success(response: any) {
      return { type: GET_BRANDWISE_SCANS_SUCCESS, response };
    }
    function Error(errorMsg: any) {
      return { type: GET_BRANDWISE_SCANS_ERROR, errorMsg };
    }
  };
};
...
export const getScannedProducts = (soldbyid: string, isfiltered: boolean, productbrand: string, filteredDatas: {}) => {
  return async (dispatch: Dispatch<AnyAction>) => {
    ...
    function Success(response: any) {
      return { type: GET_PRODUCTWISE_SCANS_SUCCESS, response };
    }
    function Error(errorMsg: any) {
      return { type: GET_PRODUCTWISE_SCANS_ERROR, errorMsg };
    }
  };
};
