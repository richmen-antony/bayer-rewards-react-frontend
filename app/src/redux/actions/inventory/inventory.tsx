...
export const getOverallInventory = (data:{}) => {
    return async(dispatch: Dispatch<AnyAction>) => {
      ...
      function Success(scans: any) { return { type: GET_OVERALL_INVENTORY_SUCCESS, scans } }
      function Error(errorMsg: any) { return { type: GET_OVERALL_INVENTORY_ERROR, errorMsg } }
    }
}
...
export const getBrandwiseInventory = (soldbyid:string,isfiltered:boolean,filteredDatas:{}) => {
  return async(dispatch: Dispatch<AnyAction>) => {
    ...
    function Success(response: any) { return { type: GET_BRANDWISE_INVENTORY_SUCCESS, response } }
    function Error(errorMsg: any) { return { type: GET_BRANDWISE_INVENTORY_ERROR, errorMsg } }
  }
}
...
export const getProductwiseInventory = (soldbyid:string,isfiltered:boolean, productbrand:string,filteredDatas:{}) => {
  return async(dispatch: Dispatch<AnyAction>) => {
      dispatch({ type : LOADING_REQUEST, status : true } );
    ...
    function Success(response: any) { return { type: GET_PRODUCTWISE_INVENTORY_SUCCESS, response } }
    function Error(errorMsg: any) { return { type: GET_PRODUCTWISE_INVENTORY_ERROR, errorMsg } }
  }
}
