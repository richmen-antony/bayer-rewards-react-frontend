...
const useStyles = (theme: Theme) => ({
  root: {
    ...
    "& .Mui-selected": {
      background:
        "transparent linear-gradient(90deg, #03BCFB 0%, #025E7E 100%) 0% 0% no-repeat padding-box",
      color: "#FFFFFF",
    },
    "& button": {
            ...
            <div className="row">
              ...
              >
                <div className="col-sm-4 pl-0">
                  <FormattedMessage id="pagination.total" />{" "}
                  {totalLabel || "Users"}: {totalData || 0}
                </div>

                <div className="col-sm-5">
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <span style={{ marginRight: "10px" }}>
                      <FormattedMessage id="pagination.rowsPerPage" />
                    </span>
                    <span style={{ width: "25%" }}>
                      <Dropdown
                        name="perpage"
                ...
                <div className="col-sm-4">
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <span style={{ marginRight: "10px" }}>
                      <FormattedMessage id="pagination.goToPage" />
                    </span>
                    <span style={{ width: "25%" }}>
                      <input
                        style={{ width: "100%" }}
